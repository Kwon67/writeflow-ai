  ...
  return (
    <section className="relative py-32 overflow-hidden bg-[#030014]">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/3 left-0 w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[150px]" />
        <div className="absolute bottom-1/3 right-0 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[150px]" />
      </div>
