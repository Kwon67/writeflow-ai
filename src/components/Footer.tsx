          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-2xl font-bold text-white">WriteFlow AI</span>
              </div>
              <p className="text-gray-400 mb-6">
                Write 10x faster with AI-powered content generation for blogs, emails, social media, and more.
              </p>
